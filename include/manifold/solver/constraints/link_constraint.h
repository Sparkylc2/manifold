...
class LinkConstraint : public Constraint {
  public:
    ...
    void set_body_1(RigidBody *b) { m_bodies[0] = b; }
    void set_body_2(RigidBody *b) { m_bodies[1] = b; }

    void set_local_pos1(const Vector2d &p) { m_local_1 = p; }
    void set_local_pos2(const Vector2d &p) { m_local_2 = p; }
