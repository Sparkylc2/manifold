...
// ---- bar ----
inline void draw_body_bar(Renderer *r, double x, double y, double length,
...
inline void draw_body_bar(Renderer *r, const Eigen::Vector2d &p, double length,
                          double width, double theta,
                          const BodyStyle &style = {}) {
...
// ---- disk ----
inline void draw_body_disk(Renderer *r, double x, double y, double radius,
...
inline void draw_body_disk(Renderer *r, const Eigen::Vector2d &p, double radius,
                           double theta, const BodyStyle &style = {}) {
...
inline void draw_body_block_circular(Renderer *r, const Eigen::Vector2d &p,
                                     double width, double height, double theta,
                                     const BodyStyle &style = {}) {
...
// ---- block (rectangular) ----
inline void draw_body_block(Renderer *r, double x, double y, double width,
...
inline void draw_body_block(Renderer *r, const Eigen::Vector2d &p, double width,
                            double height, double theta,
                            const BodyStyle &style = {}) {
...
inline void draw_body_node(Renderer *r, const Eigen::Vector2d &p, double radius,
                           const BodyStyle &style = {}) {
    draw_body_node(r, p.x(), p.y(), radius, style);
}

// ---- pivot ----
inline void draw_pivot(Renderer *r, double x, double y,
...
inline void draw_pivot(Renderer *r, const Eigen::Vector2d &p,
                       const PivotStyle &style = {}) {
