...
inline void draw_dashed_line(Renderer *r, const Eigen::Vector2d &p0,
                             const Eigen::Vector2d &p1, float thickness,
                             Color color, double dash = 0.15,
                             double gap = 0.1) {
...
inline void draw_coil_spring(Renderer *r, double x0, double y0, double x1,
                             double y1, int coils, double amp, float thickness,
                             Color color) {
    double dx = x1 - x0, dy = y1 - y0;
    double len = std::sqrt(dx * dx + dy * dy);
    if (len < 1e-4)
...
inline void draw_arc(Renderer *r, const Eigen::Vector2d &c, double radius,
                     double start_angle, double end_angle, float thickness,
                     Color color, int segments = 24) {
...
inline void draw_dashed_arc(Renderer *r, const Eigen::Vector2d &c,
...
inline void draw_angle_marker(Renderer *r, const Eigen::Vector2d &c,
                              double ref_angle, double current_angle,
                              double radius, float thickness, Color color,
                              Color ref_color,
                              const AngleMarkerStyle &style = {}) {
...
// ---- displacement arrow ----
inline void draw_displacement(Renderer *r, double x0, double y0, double x1,
...
inline void draw_displacement(Renderer *r, const Eigen::Vector2d &p0,
                              const Eigen::Vector2d &p1, const char *fmt,
                              double value, float thickness, Color color,
                              double ref_angle,
                              const DisplacementStyle &style = {}) {
...
inline void draw_dimension(Renderer *r, const Eigen::Vector2d &p0,
                           const Eigen::Vector2d &p1, const char *fmt,
                           double value, float thickness, Color color,
                           double offset = 0.3) {
...
inline void draw_velocity_arrow(Renderer *r, const Eigen::Vector2d &p,
                                const Eigen::Vector2d &v, double scale,
...
inline void draw_force_arrow(Renderer *r, const Eigen::Vector2d &p,
                             const Eigen::Vector2d &f, double scale,
                             float thickness, Color color) {
...
inline void draw_reference_cross(Renderer *r, const Eigen::Vector2d &p,
                                 double size, float thickness, Color color) {
    draw_reference_cross(r, p.x(), p.y(), size, thickness, color);
}

// ---- text label ----
inline void label(Renderer *r, double wx, double wy, const char *text,
...
inline void label(Renderer *r, const Eigen::Vector2d &p, const char *text,
                  const LabelStyle &style = {}) {
    label(r, p.x(), p.y(), text, style);
}

// ---- text label with leader line ----
inline void label_with_line(Renderer *r, double x0, double y0, double x1,
                            double y1, const char *text, int font_size,
...
inline void label_with_line(Renderer *r, const Eigen::Vector2d &p0,
                            const Eigen::Vector2d &p1, const char *text,
                            int font_size, Color line_color, Color text_color,
                            const LabelLineStyle &style = {}) {
